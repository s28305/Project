        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_SoftwareSystems_Id_Version", x => new { x.Id, x.Version });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pesel = table.Column<string>(type: "nvarchar(14)", maxLength: 14, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Contracts_SoftwareSystems_SoftwareSystemId_SoftwareVersion",
                        columns: x => new { x.SoftwareSystemId, x.SoftwareVersion },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contracts_SoftwareSystemId_SoftwareVersion",
                table: "Contracts",
                columns: new[] { "SoftwareSystemId", "SoftwareVersion" });
